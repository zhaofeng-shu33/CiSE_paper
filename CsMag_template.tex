...
The reusable library can be deployed to public available package repository. For example, in Python programming language, it is \url{pypi.org}. The following table shows the deployment result to pypi made by an independent researcher using DevOps:
\begin{table}
\centering

...
\begin{block}{}
\begin{centering}
Run experiments with the help of Cloud DevOps can guarantee the reproducibility to a large extent.
\end{centering}
\end{block}
Advantages:
\begin{itemize}
...
\item Cloud DevOps is going to support more architectures like ARM variants.
